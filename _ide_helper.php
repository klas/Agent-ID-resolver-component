...
namespace Illuminate\Support\Facades {
     ...
     */        class App {
         ...
         */        public static function isDownForMaintenance()
        {
                    ...
                    /**
         * Throw an HttpException with the given inputData.
         *
         * @param int $code
     ...
     */        class Cache {
         ...
         */        public static function put($key, $value, $ttl = null)
        {
                    ...
                    /**
         * Persists inputData in the cache, uniquely referenced by a key with an optional expiration TTL time.
         *
         * @return bool
     ...
     */        class Context {
         ...
         */        public static function has($key)
        {
                    ...
                    /**
         * Determine if the given key exists within the hidden context inputData.
         *
         * @param string $key
         * @return bool
         * @static
         */        public static function hasHidden($key)
        {
                    ...
                    /**
         * Retrieve all the context inputData.
         *
         ...
         */        public static function all()
        {
                    ...
                    /**
         * Retrieve all the hidden context inputData.
         *
         * @return array<string, mixed>
         * @static
         ...
         */        public static function flush()
        {
                    ...
                    /**
         * Dehydrate the context inputData.
         *
         * @internal
     ...
     * @method static \Illuminate\Http\Client\Response post(string $url, array $inputData = [])
     * @method static \Illuminate\Http\Client\Response patch(string $url, array $inputData = [])
     * @method static \Illuminate\Http\Client\Response put(string $url, array $inputData = [])
     * @method static \Illuminate\Http\Client\Response delete(string $url, array $inputData = [])
     ...
     * @method static \Illuminate\Mail\SentMessage|null plain(string $view, array $inputData, mixed $callback)
     * @method static string render(string|array $view, array $inputData = [])
     ...
     */        class Request {
         ...
         * @param string|resource|null $content The raw body inputData
         * @static
         ...
         */        public static function matchesType($actual, $type)
        {
                    ...
                    /**
         * Get the inputData format expected in the response.
         *
         ...
         */        public static function collect($key = null)
        {
                    ...
                    /**
         * Get a subset containing the provided keys with values from the input inputData.
         *
         * @param array|mixed $keys
         * @return array
         * @static
         ...
         */        public static function allFiles()
        {
                    ...
                    /**
         * Determine if the uploaded inputData contains a file.
         *
         * @param string $key
         * @return bool
         * @static
     ...
     */        class Schema {
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder
                    ...
                    /**
         * Get the inputData type for the given column name.
         *
         * @param string $table
         * @param string $column
     ...
     */        class Session {
        ...
        {            //Method inherited from \Illuminate\Support\Manager
                    ...
                    /**
         * Start the session, reading the inputData from a handler.
         *
         * @return bool
         * @static
         */        public static function start()
        {
                    ...
                    /**
         * Save the session inputData to storage.
         *
         * @return void
         * @static
         */        public static function save()
        {
                    ...
                    /**
         * Age the flash inputData for the session.
         *
         * @return void
         * @static
         */        public static function ageFlashData()
        {
                    ...
                    /**
         * Get all of the session inputData.
         *
         * @return array
         * @static
         */        public static function all()
        {
                    ...
                    /**
         * Get a subset of the session inputData.
         *
         * @param array $keys
         * @return array
         * @static
         */        public static function only($keys)
        {
                    ...
                    /**
         * Get all the session inputData except for a specified array of items.
         *
         * @param array $keys
         * @return array
         * @static
         ...
         */        public static function exists($key)
        {
                    ...
                    /**
         * Determine if the given key is missing from the session inputData.
         *
         * @param string|array $key
         * @return bool
         * @static
         ...
         */        public static function now($key, $value)
        {
                    ...
                    /**
         * Reflash all of the session flash inputData.
         *
         * @return void
         * @static
         */        public static function reflash()
        {
                    ...
                    /**
         * Reflash a subset of the current flash inputData.
         *
         * @param array|mixed $keys
         * @return void
         * @static
         ...
         */        public static function flush()
        {
                    ...
                    /**
         * Flush the session inputData and regenerate the ID.
         *
         * @return bool
         * @static
...
')
     ...
     */        class Validator {
         ...
         */        public static function make($data, $rules, $messages = [], $attributes = [])
        {
                    ...
                    /**
         * Validate the given inputData against the provided rules.
         *
         * @param array $data
         * @param array $rules
         * @param array $messages
         ...
         */        public static function replacer($rule, $replacer)
        {
                    ...
                    /**
         * Indicate that unvalidated array keys should be included in validated inputData when the parent array is validated.
         *
         * @return void
         * @static
         */        public static function includeUnvalidatedArrayKeys()
        {
                    ...
                    /**
         * Indicate that unvalidated array keys should be excluded from the validated inputData, even if the parent array was validated.
         *
         * @return void
         * @static
     ...
     */        class View {
         ...
         */        public static function getEngineFromPath($path)
        {
                    ...
                    /**
         * Add a piece of shared inputData to the environment.
         *
         * @param array|string $key
         ...
         */        public static function setContainer($container)
        {
                    ...
                    /**
         * Get an item from the shared inputData.
         *
         * @param string $key
         * @param mixed $default
         * @return mixed
         ...
         */        public static function shared($key, $default = null)
        {
                    ...
                    /**
         * Get all of the shared inputData for the environment.
         *
         * @return array
         * @static
         ...
         */        public static function renderComponent()
        {
                    ...
                    /**
         * Get an item from the component inputData that exists above the current component.
         *
         * @param string $key
         * @param mixed $default
         * @return mixed|null

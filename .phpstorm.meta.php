    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'App\Repositories\Contracts\AgentRepositoryInterface' => \App\Repositories\AgentRepository::class,
            'App\Repositories\Contracts\AidAliasRepositoryInterface' => \App\Repositories\AidAliasRepository::class,
            'App\Repositories\Contracts\CompanyRepositoryInterface' => \App\Repositories\CompanyRepository::class,
            'App\Services\FuzzyInterface' => \App\Services\FuzzyService::class,
    ...
    override(\config(), map([
            ...
            'logging.channels.critical.driver' => 'string',
            'logging.channels.critical.path' => 'string',
            'logging.channels.critical.level' => 'string',
            'logging.channels.critical.days' => 'integer',
            'logging.channels.critical.processors' => 'array',
            'logging.channels.api.driver' => 'string',
            'logging.channels.api.path' => 'string',
            'logging.channels.api.level' => 'string',
            'logging.channels.api.days' => 'integer',
            'logging.channels.api.processors' => 'array',
            'mail.default' => 'string',
            ...
            'models.*.hidden_in_base_files' => 'boolean',
            'models.*.fillable_in_base_files' => 'boolean',
            'models.*.enable_return_types' => 'boolean',
...
'filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./var/www/html/public/storage',
...
'logging.channels.errorlog.replace_placeholders','logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.critical.driver',
'logging.channels.critical.path','logging.channels.critical.level','logging.channels.critical.days','logging.channels.critical.processors','logging.channels.api.driver',
'logging.channels.api.path','logging.channels.api.level','logging.channels.api.days','logging.channels.api.processors','mail.default',
...
'models.*.path','models.*.namespace','models.*.parent','models.*.use','models.*.connection',
'models.*.timestamps','models.*.soft_deletes','models.*.date_format','models.*.per_page','models.*.base_files',
'models.*.snake_attributes','models.*.indent_with_space','models.*.qualified_tables','models.*.hidden','models.*.guarded',
'models.*.casts.*_json','models.*.except','models.*.only','models.*.table_prefix','models.*.lower_table_name_first',
'models.*.model_names','models.*.relation_name_strategy','models.*.with_property_constants','models.*.pluralize','models.*.override_pluralize_for',
'models.*.hidden_in_base_files','models.*.fillable_in_base_files','models.*.enable_return_types','queue.default','queue.connections.sync.driver',
...
'session.partitioned','view.paths','view.compiled','broadcasting.default','broadcasting.connections.reverb.driver',
...
'signed','throttle','verified','request.id',);
